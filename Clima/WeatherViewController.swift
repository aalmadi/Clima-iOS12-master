...
//  WeatherApp
//
//  Created by Ankur Almadi on 12/21/2018
//
...
class WeatherViewController: UIViewController, CLLocationManagerDelegate, ChangeCityDelegate {
    ...
    let APP_ID = "f65f78f73227a6de17e029ceddb02e3c"
    ...
    @IBAction func unitSelectorPressed(_ sender: Any) {
        if unitSelector.selectedSegmentIndex == 0{
            temperatureLabel.text = String(weatherDataModel.temperature) + "°"
        }
        else {
            temperatureLabel.text = String(Int(Double(weatherDataModel.temperature) * 1.8 + 32)) + "°"
        }
    }
